"""
Módulo de creación de graficos de datos promedios mensuales.
-------------------------------------------------------------------------------
En este modulo se genera una grafica para los precios promedios mensuales, según 
...
def make_daily_prices_plot():
    ...
    daily_princes = pd.read_csv('data_lake/business/precios-mensuales.csv')
